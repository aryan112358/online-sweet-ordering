        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/ab2.png" alt=""> </a>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite Sweet</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/s1.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              POPULAR ORDERS Delicious Sweets! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Sweets Delivery website</h3>
                                <p>Now you can have Sweets pretty much wherever you are, thanks to the free easy-to-use Sweets Delivery &amp; Takeout App.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/ab2.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        <h5>Popular locations in Bangalore</h5>
                        <ul>
                            <li><a href="#">Uttarahalli</a></li>
                                <li><a href="#">Indira Nagar</a> </li>
                                <li><a href="#">Jayanagar</a> </li>
                                <li><a href="#">Rajajinagar</a> </li>
                                <li><a href="#">Malleshwaram</a> </li>
                                <li><a href="#">Richmond Town</a> </li>
                                <li><a href="#">Basavanagudi</a> </li>
                                <li><a href="#">Koramangala</a> </li>
                                <li><a href="#">Hebbal</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: <a href="tel:+91 8999952525">089999 52525</a></h5> </div>
