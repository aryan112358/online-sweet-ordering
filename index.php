...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/ab2.png" alt=""> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/s4.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Search Sweets</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Sweets</h4> </div>
                        <!-- end:Step -->
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose Sweets</h3>
                                <p>Tasty and Fresh Sweets from Restaurants.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your sweets delivered! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
